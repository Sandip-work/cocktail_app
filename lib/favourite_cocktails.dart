...
class FavouriteCocktails extends StatelessWidget {
  const FavouriteCocktails({super.key});

  @override
  Widget build(BuildContext context) {
    return const  FavouriteCocktailsPage(title: '');
  }
}

class FavouriteCocktailsPage extends StatefulWidget {
  const FavouriteCocktailsPage({super.key, required this.title});

  final String title;

  @override
  State<FavouriteCocktailsPage> createState() => _FavouriteCocktailsPageState();
}
          ...
          Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child:  Text("Your favourites Cocktails"),
              ),
              Expanded(
